// church-library-app/app/borrow/scan-book.tsx
    ...
    return (
      <View style={styles.permissionContainer}>
        ...
        <Text style={styles.permissionText}>
          To scan book QR codes, we need access to your camera
        </Text>
        <TouchableOpacity
      ...
      {!scannedCode ? (
        <>
          ...
          <View style={styles.header}>
            ...
            <Text style={styles.headerTitle}>Scan Book QR Code</Text>
          </View>
        </>
      ) : (
        <View style={styles.successContainer}>
          ...
          <Text style={styles.successTitle}>Book Scanned Successfully!</Text>
