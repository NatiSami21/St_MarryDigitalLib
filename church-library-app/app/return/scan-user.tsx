// church-library-app/app/return/scan-user.tsx
...
export default function ReturnScanUser() {
    ...
    return (
      <View style={styles.permissionContainer}>
        ...
        <Text style={styles.permissionText}>
          To scan user ID cards for returns, we need access to your camera
        </Text>
        <TouchableOpacity
      ...
      {!scannedCode ? (
        <>
          ...
          <View style={styles.header}>
            ...
            <Text style={styles.headerTitle}>Scan User ID (Return)</Text>
          </View>
        </>
      ) : (
        <View style={styles.successContainer}>
          ...
          <Text style={styles.successTitle}>User Scanned!</Text>
          ...
          <Text style={styles.instructionText}>
            Ready to confirm book return for this user
          </Text>
          ...
          <View style={styles.buttonContainer}>
            ...
            >
              ...
              <Text style={styles.secondaryButtonText}>Rescan User</Text>
            </TouchableOpacity>
            
            <TouchableOpacity
              onPress={() =>
                router.replace({
                  pathname: "/return/confirm",
                  params: {
                    book_code,
